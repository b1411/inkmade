...
// Доверие-полоса (§5.2): тонкая строка сразу под hero, снимает первичные
// возражения мгновенно. Mono-буллеты через точки-разделители.
const { t } = useI18n()
const points = computed(() =>
  [0, 1, 2, 3].map(i => t(`landing.trustBar.points[${i}]`)),
)
</script>
