...
const copy = computed(() => locale.value === 'kk'
  ? {
      label: '08 / ПІШІМ',
      title: 'Пішімді тапсырысқа дейін көр.',
      body: 'Әр негізді бірдей жарықта, алдынан және артынан көрсетеміз. Пішімін, көлемін және материалын салыстыру оңай.',
      view: 'Негізді ашу',
    }
  : {
      label: '08 / ПОСАДКА',
      title: 'Посадку видно до заказа.',
      body: 'Показываем каждую основу в одном свете, спереди и сзади. Так проще сравнить форму, объём и материал.',
      view: 'Открыть основу',
    })
</script>
